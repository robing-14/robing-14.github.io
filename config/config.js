var config = {
    ...
    age: "22",
    phone: "15632114959",
    email: "2627560733@qq.com",
    address: "湖北省荆州市",
    qq: "2627560733",
    log: "Test",
    excpect_work: "Java前/后端开发",
    ...
    welcome: "青青子衿，悠悠我心<br>" +
             "但为君故，沉吟至今<br>" +
             "你好，我是车辙豪，石家庄铁道大学大四在读<br>" +
             "很高兴见到你!",


    /*在这里配置关于我的信息，你可以内嵌HTML标签以调整格式*/
    about: "<p>你好！我叫车辙豪，性别男，石家庄铁道大学软件工程系大四在读。我期望的工作岗位是Java前/后端开发。</p>" +
    ...
    */  
     ...
     */
    portfolio: [
        ["./images/pro-1.png", "https://www.cnblogs.com/utube/", "个人博客", "这里记录了我的学习笔记<br>持续更新"],
        ["./images/pro-2.png", "", "智能人机对战五子棋", "采用C++编写的智能五子棋人机对战<br>2020/7/23"],
        ["https://pic3.zhimg.com/80/v2-d9766956d5c85c2780e4c5008fd946ca_1440w.jpg", "", "学生管理系统", "java语言+AVL树+多重双向表实现"]
    ],
    ...
    others: [
        ["2020年4月", "参与第十一届蓝桥杯", " "],
        ["2020年10月", "参与校内网页设计大赛", "获得三等奖"],
        ["2022年4月", "参与火焰杯", "获得三等奖"],
        ["2022年5月", "参与服务外包杯和软件设计大赛", " "]
    ],
